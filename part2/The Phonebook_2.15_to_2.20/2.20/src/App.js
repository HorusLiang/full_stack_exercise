...
const App = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if(hasPerson){
      ...
      noteService.updatePerson(person.id,newPerson).catch((err)=>{ // not try catch but this way
      ...
      const newPerson = { name: newName, number:newNumber} // if not refer to an id, then added automatically
